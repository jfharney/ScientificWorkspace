...
function renderTagCloud() {
  ...
  var uname = SW.current_user_uname;
      ...
      $.each(tagsArr, function(index, element) {
        ...
        $.ajax({
          ...
          success: function(linksData) {        	
        	...
        	var newLinksArr = JSON.parse(linksData);
        	//alert('newLinksArr: ' + newLinksArr);
