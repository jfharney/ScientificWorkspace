                      ...
                      success: function(data)
                      {
                          ...
                          if(length < 1) {
	                          ...
	                          var $tbody = $table.children("tbody");
                            	$tbody.append( 	"<tr>" +
            							"<td style='font-size: 12px;font-family: arial;text-align: left;border: 1px solid black;padding: 5px;'>" + data['tagname'] + "</td>" +
            							"<td style='font-size: 12px;font-family: arial;text-align: left;border: 1px solid black;padding: 5px;'>" + datal['tagdesc'] + "</td>" + 
            							"<td style='color: blue; text-decoration:underline;font-size: 12px;font-family: arial;text-align: left;border: 1px solid black;padding: 5px;'>" + tagged_items + "</td>" +
        								"<td class='objType' style='font-size: 12px;font-family: arial;text-align: left;border: 1px solid black;padding: 5px;'>" + tagged_types + "</td>" +
            							"<td style='color: blue; text-decoration:underline;font-size: 12px;font-family: arial;text-align: left;border: 1px solid black;padding: 5px;'>" + data['wtime'] + "</td>" + 
            						"</tr>");
                            	*/
